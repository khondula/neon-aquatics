...
spectra_id <- 'BARC-buoy-20140507_152342'

my_analyte <- 'DOC'

get_closest_sample <- function(spectra_id, my_analyte){
  spectra_date <- str_sub(spectra_id, 10, 18) %>% as_date()
  spectra_loc <- str_sub(spectra_id, 6, 9)
  my_df <- site_chem_df %>% 
...
# expand.grid(site_spectra_df$spectraID, my_analytes)
